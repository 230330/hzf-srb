...
public class IntegralGradeController {
    ...
    @ApiOperation(value = "根据ID更新积分等级", notes = "根据ID更新积分等级")
    ...
    @ApiOperation(value = "根据ID删除积分等级", notes = "根据ID删除积分等级")
